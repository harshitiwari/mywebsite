...
<div style="display: flex; justify-content: flex-end; margin-bottom: 1.5rem;">
  <a href="{{ '/blog/2026/salt-and-silence-hindi/' | relative_url }}" style="padding: 0.35rem 1rem; border-radius: 999px; border: 1px solid currentColor; font-size: 0.85rem; text-decoration: none; color: inherit;">
    हिंदी में पढ़ें
  </a>
</div>
